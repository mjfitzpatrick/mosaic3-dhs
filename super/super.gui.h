...
"*pdirApply.sensitive:				false",
"*pathGroup*pdirApply*background:		gray15",
"    *otfFileApply.label:			Apply",
"*otfFileApply.sensitive:			false",
"*pathGroup*otfFileApply*background:		gray15",
...
"*pdirLabel.sensitive:				false",
"*pdirValue.background:				red",
"*pathGroup*pdirValue*background:		gray15",
"*pathGroup*pdirFrame*background:		gray20",
"*pdirValue.sensitive:				false",
"    *otfFileLabel.label:			OTF Image Name:",
"    *otfFileLabel.justify:			right",
"    *otfFileValue.string:			None",
"*otfFileLabel.sensitive:			false",
"*pathGroup*otfFileValue*background:		gray15",
"*pathGroup*otfFileFrame*background:		gray20",
"*otfFileValue.sensitive:			false",
"",
...
"set stdimage            \"imt8800\"	;# make it big enough for detector",
...
"set t2s \"-------    --      --\\n\"",
"",
"#print [format \"stat: opt %s   val %s\" [lindex $new 0] [lindex $new 1] ]",
"",
"    switch $opt {",
...
"",
"set smcNodeDescr {",
"    {	\"mosaic3dhs-01\"  f.exec { showSMCHost mosaic3dhs-01 } }",
